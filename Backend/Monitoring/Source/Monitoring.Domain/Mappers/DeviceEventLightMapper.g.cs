namespace Monitoring.Domain.Mappers
{
    ...
    {
        public Monitoring.Contracts.DeviceEvents.DeviceEventDtoLight MapToDto(Monitoring.Dal.Models.DeviceEvent p1)
        {
        ...
        public Monitoring.Dal.Models.DeviceEvent MapFromDto(Monitoring.Contracts.DeviceEvents.DeviceEventDtoLight p4)
        {
